...
//  StudyBox_iOS
//
//  Created by Piotr Tobolski on 27.02.2016.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        // This code uses a directory named "com.blstream.StudyBox_iOS" in the application's documents Application Support directory.
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        */
        ...
        do {
            ...
            // Replace this with code to handle the error appropriately. abort() causes the application to generate a crash log and terminate.
